	...
	*/
	...
	echo '
		<div class="row" style="padding-top: 20px;">
			<div class="span6"><h3>'.$company.'</h3></div>	
			<div class="span6"><h3 class="pull-right">'.$city.'</h3></div>
		</div> <!-- end row-->
			
		<div class="row">
			<div class="span6"><span style="font-style:italic; font-size: 18px;">'.$job.'</span></div>	
			<div class="span6"><span style="font-style:italic; font-size: 18px;" class="pull-right">'.$dates.'</span></div>
		</div> <!-- end row-->
		';
		if (!empty($blob)) {
			echo '
