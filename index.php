...
-->
	...
	<div class="span12">
      ...
      <h1 style="padding: 10px 0px; text-align: center; font-size: 60px; line-height: 70px; text-transform: lower">Philip I. Thomas</h1>
